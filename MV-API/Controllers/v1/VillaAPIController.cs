...
namespace MV-API.Controllers.v1
{
    [Route("api/v{version:apiVersion}/VillaAPI")]
    [ApiController]
    [ApiVersion("1.0")] // This might need updating to [ApiVersion(1.0)] depending on new package
    public class VillaAPIController : ControllerBase
    {
            ...
            int pageNumber = 1)
        {
            try
            {
                ...
                Response.Headers.Append("X-Pagination", JsonSerializer.Serialize(pagination)); // Updated method
